...
more_than_max_name_length_input = 33
min_telephone_length_input = 3
max_telephone_length_input = 32
...
registration_terms_warning_message = "Warning: You must agree to the Privacy Policy!"
registration_firstname_error_message = "First Name must be between 1 and 32 characters!"
registration_lastname_error_message = "Last Name must be between 1 and 32 characters!"
